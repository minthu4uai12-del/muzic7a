...
import { Shield, Users, CreditCard, TrendingUp, CheckCircle, XCircle, Clock, Eye, MessageSquare, FileText, Zap, Key } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* API Key Stats Button - Admin Only */}
        {usage?.apiKeyStats && usage.apiKeyStats.length > 0 && (
          <button
            onClick={() => setShowApiStats(true)}
            className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg text-sm transition-colors flex items-center space-x-2"
          >
      ...
      {/* API Key Stats Modal - Admin Only */}
      <ApiKeyStatsModal
        isOpen={showApiStats}
